...
if [[ "$AWS_REGION" == "cn-north-1" ]] || [[ "$AWS_REGION" == "cn-northwest-1" ]]; then
        wget https://pricing.cn-north-1.amazonaws.com.cn/offers/v1.0/cn/AmazonEC2/current/$AWS_REGION/index.json -O /apps/soca/$SOCA_CONFIGURATION/cluster_analytics/pricing_index.json
